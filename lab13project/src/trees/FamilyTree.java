...
//        ArrayList<TreeNode> getNodeWithName(String targetName)
//        {
...
public class FamilyTree {
    ...
    private static class TreeNode {
        ...
        void addChild(TreeNode childNode) {
            // Add childNode to this node's children list and set childNode's parent to this node.
            children.add(childNode);
            childNode.parent = this;
        }
        ...
        TreeNode getNodeWithName(String targetName) {
            ...
            // Recurse through children nodes to find the target name.
            for (TreeNode child : children) {
                TreeNode foundNode = child.getNodeWithName(targetName);
                if (foundNode != null) {
                    return foundNode;
    ...
    public FamilyTree() throws IOException, TreeException {
        ...
        // Parse the input file and create a FileReader that reads treeFile.
        FileReader fr = new FileReader(treeFile);
        BufferedReader br = new BufferedReader(fr);
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
        ...
        for (TreeNode ancestor1 : ancestorsOf1) {
            if (ancestorsOf2.contains(ancestor1)) {
                return ancestor1;
            }
        }
...
// Define the TreeException class.
